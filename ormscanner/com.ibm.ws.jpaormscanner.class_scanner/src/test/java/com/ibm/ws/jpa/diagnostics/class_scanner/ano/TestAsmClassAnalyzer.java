...
//            dumpClassXML(cit);
	...
	private void testSimpleEntityClass(ClassInfoType cit) {
	    assertEquals("com.ibm.ws.jpa.diagnostics.class_scanner.ano.testentities.SimpleJPAEntity", cit.getClassName());
        assertEquals("com.ibm.ws.jpa.diagnostics.class_scanner.ano.testentities", cit.getPackageName());
...
//                assertEquals("com.ibm.ws.jpa.diagnostics.class_scanner.ano.testentities.SimpleJPAEntity", mit.getReturnType());
        ...
        assertEquals("com.ibm.ws.jpa.diagnostics.class_scanner.ano.testentities.SimpleJPAEntity$DumbInnerClass", innerCit.getClassName());
	}
}
